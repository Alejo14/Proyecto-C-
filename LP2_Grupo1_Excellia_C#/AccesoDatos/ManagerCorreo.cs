...
{
    public class ManagerCorreo
    {
        MailMessage correos = new MailMessage();
        SmtpClient envios = new SmtpClient();

        public void enviarCorreo(string emisor, string emisorCC, string emisorBCC, string password,
            string mensaje, string asunto, string destinatario, string ruta)
        {
            try
            {
                correos.To.Clear();
                ...
                envios.Send(correos);
                MessageBox.Show("El documento solicitado ha sido enviado a la(s) dirección(es) indicada(s)", "Éxito de operación", MessageBoxButtons.OK,
